		...
		>
			...
			>
				<div style={{ textAlign: "center", marginBottom: token.marginXL * 2 }}>
					...
					>
						ChillTeacher tập hợp tất cả các công cụ bạn cần để tạo ra các bài
						học hấp dẫn, hiệu quả đồng thời giúp bạn tiết kiệm thời gian cho các
				...
				<div style={{ marginTop: token.marginXL * 2, textAlign: "center" }}>
					...
					>
						...
						>
							Tham gia cùng hàng nghìn giáo viên đã khám phá ra sự khác biệt của
							ChillTeacher.
						</Paragraph>
						<Button
							type="primary"
